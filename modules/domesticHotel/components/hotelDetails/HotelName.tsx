...
const HotelName: React.FC<Props> = props => {
    ...
    return (
        <>
            ...
            {!!(showMap && hotelData.Latitude && hotelData.Longitude) && <div className='z-[1002] fixed bg-black/75 top-0 left-0 w-full h-full flex items-center justify-center'  onClick={()=>{setShowMap(false)}}>
