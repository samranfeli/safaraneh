    ...
    return (
        <div className="mt-24 space-y-3">
            ...
            <ul className="list-decimal p-5 pb-0 leading-9">
                ...
                <li> با بخش فروش سازمانی سفرانه تماس بگیرید.</li>
            </ul>
            <p>
            راه دیگر نیز تماس مستقیم با بخش فروش سازمانی سفرانه است که در اینصورت هماران فرکوش سازمانی اطلاعات شرکت شما را ثبت خواهند کرد.
            </p>
            <p>
            تلفن تماس 02126150051 داخلی 4
            </p>
        </div>
    )
}
