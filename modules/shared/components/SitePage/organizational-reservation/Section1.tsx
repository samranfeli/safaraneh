            ...
            <div className="w-1/2 max-md:w-full z-10">
                ...
                <div className="flex gap-5 mt-7 text-gray-500">
                    <div className="relative">
                        ...
                        <p className="pt-2 max-sm:text-sm">تخفیف و پیشنهادات ویژه</p>
                    </div>
                    <div className="relative">
                        ...
                        <p className="pt-2 max-sm:text-sm">پشتیبانی اختصاصی</p>
                    </div>
                    <div className="relative">
                        ...
                        <p className="pt-2 max-sm:text-sm">تضمین کمترین قیمت</p>
                    </div>
                </div>
