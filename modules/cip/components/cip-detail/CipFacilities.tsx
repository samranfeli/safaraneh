    ...
    return (
        <div className="py-5 " id="anchoraboutairport">
            ...
            <div className='bg-white inserted-content rounded-lg border border-neutral-300 p-5 mb-5 md:mb-8 text-base leading-8'>
                {facilities?.map(item => (
                    <div key={item.id}
                        className='grid grid-cols-4 mb-4 gap-5'
                    >

                        <div className="bg-neutral-100 flex flex-col gap-3 items-center justify-center">
                            <img
                        ...
                        <ul className='list-none text-xs col-span-3 leading-5'>
                            {item.description?.split(',').map(facilityItem => <li key={facilityItem} className="mb-0">
                                <img
