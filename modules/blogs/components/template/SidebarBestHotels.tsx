...
const BestHotels: NextPage = () => {
    return (
        <div className="grid max-lg:grid-cols-3 max-sm:grid-cols-1 space-y-5 max-lg:space-y-0 max-sm:space-y-5">
                ...
                <div className="text-xs absolute bottom-1/4 right-10 left-10 max-md:left-7 max-md:right-7  bg-white rounded text-center opacity-70 max-sm:opacity-100 hover:opacity-100 translation-all duration-300">
