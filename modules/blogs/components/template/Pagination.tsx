...
const Pagination: NextPage<any> = ({ perPage }) => {
    ...
    return (
        <div className="flex flex-wrap justify-center rounded mt-4 max-sm:m-4 p-3 max-md:gap-6 max-sm:gap-3 gap-10" style={{ border: 'solid 1px rgba(0,0,0,.2)' }}>
            ...
            <span className={ `${+router - listPage[0] <= 2 && 'hidden'} cursor-pointer`} onClick={() => btnClick(listPage[0],false)}>{listPage[0]}</span>
            ...
            <span
                className={` ${!listPage.includes(+router - 2) && 'hidden'} cursor-pointer pl-2 pr-2 hover:bg-gray-200 rounded translation-all duration-300`}
                onClick={() => btnClick(+router - 2, false)} >{+router - 2}
            </span>
            <span
                className={` ${!listPage.includes(+router - 1) && 'hidden'} cursor-pointer pl-2 pr-2 hover:bg-gray-200 rounded translation-all duration-300`}
                onClick={() => btnClick(+router - 1, false)}>{+router - 1}
            </span>

            
            <span className={`cursor-pointer bg-blue-600 pl-2  pr-2  rounded-sm text-white`} onClick={() => btnClick(+router,false)}>{+router}</span>
            ...
            <span className={` ${+router + 2 >= listPage[+listPage.length - 1] && 'hidden'} cursor-pointer`}
